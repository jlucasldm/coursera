...
# uma lista com números inteiros, verifica se tal lista 
# possui elementos repetidos e os remove. A função deve 
# devolver uma lista correspondente à primeira lista, sem 
